...
func EmailNotification(userEmail string, trackerUrl string) {
	...
	message.SetBody("text/plain", "Your tracker found price changing at "+trackerUrl)
	...
	log.Printf("Email sent to %s with link %s", userEmail, trackerUrl)
}
